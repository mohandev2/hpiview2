#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.5 on Mon Oct  1 21:27:27 2007 from newHpiView
...
class Hpiview_Window(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.window_1 = wx.SplitterWindow(self, -1, style=wx.SP_3D|wx.SP_BORDER|wx.SP_PERMIT_UNSPLIT)
        self.window_1_pane_2 = wx.ScrolledWindow(self.window_1, -1, style=wx.TAB_TRAVERSAL)
        self.window_2 = wx.SplitterWindow(self.window_1_pane_2, -1, style=wx.SP_3D|wx.SP_BORDER|wx.SP_PERMIT_UNSPLIT)
        ...
        self.frame_2_toolbar.AddLabelTool(203, "Subscribe events", wx.Bitmap("images/unsubscribe events.bmp", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        ...
        self.tree_ctrl_1 = wx.TreeCtrl(self.notebook_1_pane_1, -1, style=wx.TR_HAS_BUTTONS|wx.TR_DEFAULT_STYLE|wx.SUNKEN_BORDER)
        self.text_ctrl_1 = wx.TextCtrl(self.notebook_1_pane_1, -1, "", style=wx.TE_MULTILINE|wx.TE_RICH2|wx.TE_WORDWRAP)
        self.bitmap_button_3 = wx.BitmapButton(self.window_1_pane_1, -1, wx.Bitmap("images/Bottom toolbar1.bmp", wx.BITMAP_TYPE_ANY))
        self.bitmap_button_4 = wx.BitmapButton(self.window_1_pane_1, -1, wx.Bitmap("images/Bottom toolbar2.bmp", wx.BITMAP_TYPE_ANY))
        self.text_ctrl_2 = wx.TextCtrl(self.window_2_pane_1, -1, "", style=wx.TE_MULTILINE|wx.TE_RICH2)
        self.list_ctrl_1 = wx.ListCtrl(self.window_2_pane_2, -1, style=wx.LC_REPORT|wx.SUNKEN_BORDER)
    ...
    def __do_layout(self):
        ...
        grid_sizer_8.Add(self.bitmap_button_4, 0, 0, 0)
        grid_sizer_8.Add((700, 20), 0, 0, 0)
        self.window_1_pane_1.SetSizer(grid_sizer_8)
        grid_sizer_8.AddGrowableRow(0)
        grid_sizer_5.Add(self.text_ctrl_2, 0, wx.EXPAND, 0)
        self.window_2_pane_1.SetSizer(grid_sizer_5)
        grid_sizer_5.AddGrowableRow(0)
        grid_sizer_5.AddGrowableCol(0)
        grid_sizer_4.Add(self.list_ctrl_1, 1, wx.EXPAND, 0)
        self.window_2_pane_2.SetSizer(grid_sizer_4)
	...
	self.window_1.Unsplit(self.window_1.GetWindow2())
