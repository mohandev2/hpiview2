...
class Hpiview_Window(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.frame_2_toolbar.AddLabelTool(201, "Close", wx.Bitmap(os.path.dirname(__file__)+"/images/close.gif", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
	#self.frame_2_toolbar.SetToolTipString("Close")
        self.frame_2_toolbar.AddLabelTool(202, "Discover", wx.Bitmap(os.path.dirname(__file__)+"/images/discover.gif", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
	#self.frame_2_toolbar.SetToolTipString("Discover")
        self.frame_2_toolbar.AddCheckLabelTool(203, "Subscribe events", wx.Bitmap(os.path.dirname(__file__)+"/images/subscribe.gif", wx.BITMAP_TYPE_ANY), wx.NullBitmap, "", "")
        self.frame_2_toolbar.AddLabelTool(204, "Get events", wx.Bitmap(os.path.dirname(__file__)+"/images/getevent.gif", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        # Tool Bar end
        self.bitmap_button_1 = wx.BitmapButton(self.panel_1, -1, wx.Bitmap(os.path.dirname(__file__)+"/images/hidesession.gif", wx.BITMAP_TYPE_ANY))
	self.bitmap_button_1.SetToolTipString("Hide domain list")
        self.bitmap_button_2 = wx.BitmapButton(self.panel_1, -1, wx.Bitmap(os.path.dirname(__file__)+"/images/newsession.gif", wx.BITMAP_TYPE_ANY))
