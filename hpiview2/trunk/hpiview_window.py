...
class Hpiview_Window(wx.Frame):
    ...
    # begin wxGlade: Hpiview_Window.__init__
        ...
        self.text_ctrl_1 = wx.TextCtrl(self.panel_1, -1, "", style=wx.TE_RICH2|wx.TE_MULTILINE|wx.TE_RICH|wx.TE_LINEWRAP)
    ...
    def __set_properties(self):
        ...
        for i in range(len(frame_1_statusbar_fields)):
            ...
            self.text_ctrl_1.SetMinSize((355, 450))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        sizer_5.Add(self.list_box_1, 4, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 5)
        sizer_6.Add(self.tree_ctrl_1, 1, wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_7.Add(self.text_ctrl_1, 0, wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        sizer_5.Add(self.notebook_1, 8, wx.ADJUST_MINSIZE|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_4.Add(sizer_5, 8, wx.EXPAND, 0)
